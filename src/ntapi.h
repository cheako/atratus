...
//NTSTATUS NTAPI NtQueryInformationFile(HANDLE,FILE_INFORMATION_CLASS,PVOID,ULONG,PULONG);
...
NTSTATUS NTAPI NtWriteVirtualMemory(HANDLE,PVOID,PCVOID,ULONG,PULONG);
